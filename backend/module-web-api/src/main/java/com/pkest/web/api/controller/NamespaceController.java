...
public class NamespaceController extends BaseController<NamespaceService> {
    ...
    public ResponseBean<NamespaceModel> create(
            @RequestBody @Validated({Insert.class, Save.class}) NamespaceBody body) throws HYException{
        return ResultCode.SUCCESS.wrap(getService().create(body.toDto(NamespaceModel.class)));
    }
